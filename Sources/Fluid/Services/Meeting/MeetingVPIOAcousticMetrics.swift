...
nonisolated enum MeetingVPIOAcousticMetrics {
    ...
    static let minimumAnalysisFrames = 4096
    ...
    static let bands: [(lowHz: Double, highHz: Double)] = [
        (180, 400), (400, 900), (900, 1800), (1800, 3600), (3600, 7800),
    ]
    ...
    private static func bandMetrics(
        ...
        guard let spectra = crossSpectra(reference: reference, captured: captured) else {
